...
CRD_CHART_DIR="${REPO_DIR}/helm/kamaji/charts/kamaji-crds" ; readonly CRD_CHART_DIR

# root dir of the vendir synced chart
VENDIR_SYNC_DIR="${REPO_DIR}/vendor/kamaji/charts/kamaji" ; readonly VENDIR_SYNC_DIR
