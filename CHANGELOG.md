...
- Update chart to upstream tag `edge-26.2.5`.

### Changed

- Update `ciliumNetworkPolicy` for kamaji-etcd.
...
[Unreleased]: https://github.com/giantswarm/kamaji-app/compare/v0.2.1...HEAD
